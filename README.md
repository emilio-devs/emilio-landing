...
- 🎼 [Portfolio web para músico](https://rortizserrano.com/): Desarrollo de una web + hosting de portfolio con **WordPress como backend headless**, utilizando **custom post types y campos personalizados (ACF)** para la gestión dinámica del contenido y consumo vía API desde el frontend. Solución ligera, fácil de mantener y alojable en hosting genérico, sin necesidad de backend complejo ni VPS.
